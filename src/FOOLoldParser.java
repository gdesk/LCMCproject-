...
public class FOOLoldParser extends Parser {
	...
	public FOOLoldParser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public TerminalNode SEMIC() { return getToken(FOOLoldParser.SEMIC, 0); }
		public TerminalNode LET() { return getToken(FOOLoldParser.LET, 0); }
		public TerminalNode IN() { return getToken(FOOLoldParser.IN, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).exitProg(this);
		}
	}
	...
	public static class DeclistContext extends ParserRuleContext {
		...
		public TerminalNode ID(int i) {
			return getToken(FOOLoldParser.ID, i);
		}
		public TerminalNode COMMA(int i) {
			return getToken(FOOLoldParser.COMMA, i);
		}
		public TerminalNode RPAR(int i) {
			return getToken(FOOLoldParser.RPAR, i);
		}
		public List<TerminalNode> ID() { return getTokens(FOOLoldParser.ID); }
		public TerminalNode SEMIC(int i) {
			return getToken(FOOLoldParser.SEMIC, i);
		}
		public List<TerminalNode> VAR() { return getTokens(FOOLoldParser.VAR); }
		public TerminalNode LPAR(int i) {
			return getToken(FOOLoldParser.LPAR, i);
		}
		public List<TerminalNode> COMMA() { return getTokens(FOOLoldParser.COMMA); }
		public List<TypeContext> type() {
			return getRuleContexts(TypeContext.class);
		}
		public TerminalNode LET(int i) {
			return getToken(FOOLoldParser.LET, i);
		}
		...
		public List<TerminalNode> COLON() { return getTokens(FOOLoldParser.COLON); }
		public TerminalNode FUN(int i) {
			return getToken(FOOLoldParser.FUN, i);
		}
		public TerminalNode VAR(int i) {
			return getToken(FOOLoldParser.VAR, i);
		}
		public List<TerminalNode> LPAR() { return getTokens(FOOLoldParser.LPAR); }
		public ExpContext exp(int i) {
			return getRuleContext(ExpContext.class,i);
		}
		public List<TerminalNode> IN() { return getTokens(FOOLoldParser.IN); }
		public List<TerminalNode> SEMIC() { return getTokens(FOOLoldParser.SEMIC); }
		public TerminalNode IN(int i) {
			return getToken(FOOLoldParser.IN, i);
		}
		public TerminalNode COLON(int i) {
			return getToken(FOOLoldParser.COLON, i);
		}
		public List<TerminalNode> RPAR() { return getTokens(FOOLoldParser.RPAR); }
		public List<TerminalNode> ASS() { return getTokens(FOOLoldParser.ASS); }
		public List<TerminalNode> FUN() { return getTokens(FOOLoldParser.FUN); }
		public List<TerminalNode> LET() { return getTokens(FOOLoldParser.LET); }
		public TerminalNode ASS(int i) {
			return getToken(FOOLoldParser.ASS, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).enterDeclist(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).exitDeclist(this);
		}
	}
		...
		try {
			...
			do {
				...
				case FUN:
					...
					if (_la==ID) {
						{
						setState(45); ((DeclistContext)_localctx).fid = match(ID);
						...
						while (_la==COMMA) {
							...
							setState(50); ((DeclistContext)_localctx).id = match(ID);
	...
	public static class TypeContext extends ParserRuleContext {
		public Node ast;
		public TerminalNode BOOL() { return getToken(FOOLoldParser.BOOL, 0); }
		public TerminalNode INT() { return getToken(FOOLoldParser.INT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).enterType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).exitType(this);
		}
	}
	...
	public static class ExpContext extends ParserRuleContext {
		...
		public List<TerminalNode> PLUS() { return getTokens(FOOLoldParser.PLUS); }
		public TerminalNode PLUS(int i) {
			return getToken(FOOLoldParser.PLUS, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).enterExp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).exitExp(this);
		}
	}
	...
	public static class TermContext extends ParserRuleContext {
		...
		public TerminalNode TIMES(int i) {
			return getToken(FOOLoldParser.TIMES, i);
		}
		public FactorContext factor(int i) {
			return getRuleContext(FactorContext.class,i);
		}
		public List<TerminalNode> TIMES() { return getTokens(FOOLoldParser.TIMES); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).enterTerm(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).exitTerm(this);
		}
	}
	...
	public static class FactorContext extends ParserRuleContext {
		...
		public TerminalNode EQ(int i) {
			return getToken(FOOLoldParser.EQ, i);
		}
		public List<TerminalNode> EQ() { return getTokens(FOOLoldParser.EQ); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).enterFactor(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).exitFactor(this);
		}
	}
	...
	public static class ValueContext extends ParserRuleContext {
		...
		public TerminalNode ELSE() { return getToken(FOOLoldParser.ELSE, 0); }
		public TerminalNode IF() { return getToken(FOOLoldParser.IF, 0); }
		public TerminalNode PRINT() { return getToken(FOOLoldParser.PRINT, 0); }
		public TerminalNode INTEGER() { return getToken(FOOLoldParser.INTEGER, 0); }
		public TerminalNode FALSE() { return getToken(FOOLoldParser.FALSE, 0); }
		public List<TerminalNode> CRPAR() { return getTokens(FOOLoldParser.CRPAR); }
		public TerminalNode TRUE() { return getToken(FOOLoldParser.TRUE, 0); }
		public TerminalNode THEN() { return getToken(FOOLoldParser.THEN, 0); }
		public TerminalNode LPAR() { return getToken(FOOLoldParser.LPAR, 0); }
		public List<TerminalNode> CLPAR() { return getTokens(FOOLoldParser.CLPAR); }
		public ExpContext exp(int i) {
			return getRuleContext(ExpContext.class,i);
		}
		public TerminalNode COMMA(int i) {
		...
		public TerminalNode ID() { return getToken(FOOLoldParser.ID, 0); }
		public TerminalNode CLPAR(int i) {
			return getToken(FOOLoldParser.CLPAR, i);
		}
		public TerminalNode CRPAR(int i) {
			return getToken(FOOLoldParser.CRPAR, i);
		}
		public List<TerminalNode> COMMA() { return getTokens(FOOLoldParser.COMMA); }
		public TerminalNode RPAR() { return getToken(FOOLoldParser.RPAR, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).enterValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLoldListener ) ((FOOLoldListener)listener).exitValue(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\2\2\34\35\b\2\1\2\35\36\7\6\2\2\36\3\3\2\2\2\37P\b\3\1\2 !\7\27\2\2!"+
		"\"\7\33\2\2\"#\7\3\2\2#$\5\6\4\2$%\7\5\2\2%&\5\b\5\2&\'\b\3\1\2\'M\3\2"+
		"\2\2()\7\30\2\2)*\7\33\2\2*+\7\3\2\2+,\5\6\4\2,-\b\3\1\2-.\7\r\2\2.>\b"+
		"\3\1\2/\60\7\33\2\2\60\61\7\3\2\2\61\62\5\6\4\2\62;\b\3\1\2\63\64\7\4"+
		"\2\2\64\65\7\33\2\2\65\66\7\3\2\2\66\67\5\6\4\2\678\b\3\1\28:\3\2\2\2"+
